...
export function BuildRow({
  ...
  return (
    <Link
      href={href}
      className={cn(
        'group flex min-h-16 flex-col gap-3 px-3 py-3 transition-colors hover:bg-muted/50 focus-visible:bg-muted/50 focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none focus-visible:ring-inset sm:flex-row sm:items-center sm:justify-between',
    ...
    >
      ...
      <div className="flex shrink-0 items-center justify-between gap-4 sm:justify-end sm:pl-4">
        ...
        <ArrowRight
          aria-hidden="true"
          className="h-4 w-4 text-muted-foreground motion-safe:transition-transform motion-safe:group-hover:translate-x-0.5"
        />
      </div>
    </Link>
  )
